module due-game-example

go 1.22

require (
	github.com/dobyte/due/locate/redis/v2 v2.0.0-20240805030140-d7a6a45f34e9
	github.com/dobyte/due/network/ws/v2 v2.0.0-20240805030140-d7a6a45f34e9
	github.com/dobyte/due/registry/consul/v2 v2.0.0-20240805030140-d7a6a45f34e9
	github.com/dobyte/due/transport/rpcx/v2 v2.0.0-20240805030140-d7a6a45f34e9
